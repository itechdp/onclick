  ...
  getPolicies: async (userId?: string): Promise<Policy[]> => {
    try {
      ...
      const policies: Policy[] = (data || []).map(row => ({
        ...
        subAgentCommissionPercentage: row.sub_agent_commission_percentage,
        subAgentCommissionAmount: row.sub_agent_commission_amount,
        remark: row.remark,
  ...
  addPolicy: async (
    ...
    try {
      ...
      const dbPolicy = {
        ...
        sub_agent_id: policyData.subAgentId || null,
        sub_agent_commission_percentage: policyData.subAgentCommissionPercentage,
        sub_agent_commission_amount: policyData.subAgentCommissionAmount,
